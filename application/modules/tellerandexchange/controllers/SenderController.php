...
class Tellerandexchange_SenderController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
    	try{
    		...
    		$collumns = array("BRANCH_NAME","CUSTOMER","CURRENCY","Invoice","​AMT_PAY","BRANCH_NOTE","DATE","STATUS");
    		$link=array(
    ...
    public function editAction()
    {
    	if($this->getRequest()->isPost()){
			...
			if(!empty($data['saveclose'])){
					Application_Form_FrmMessage::Sucessfull("UPDATE_SUCCESS","/tellerandexchange/sender/index");
				}else{
